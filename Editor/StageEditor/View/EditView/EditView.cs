...
namespace Kiro.Editor.StageEditor.View.EditView
{
    ...
    /// </summary>
    public sealed class EditView : VisualElement, IDisposable
    {
        ...
        {
            var buttonContent = this.Q<VisualElement>("play-stage-button");
            var button = new Button { text = "このステージをプレイ" };
            button.clicked += () => _playButtonClicked.OnNext(Unit.Default);
